odoo.define("surgi_inventory_adjustments_scan.adjScanning", function(require) {
    ...
    var adjScanning = AbstractAction.extend({
        template: "adjScanning",
        xmlDependencies: ['/surgi_inventory_adjustments_scan/static/src/xml/stock.xml'],
        events: {
...
$("#trackingModal").modal();
    ...
    core.action_registry.add('stock.inventory', adjScanning);
    return adjScanning;
});